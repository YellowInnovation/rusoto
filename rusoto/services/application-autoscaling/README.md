...
# Rusoto ApplicationAutoScaling
Rust SDK for Application Auto Scaling
...
To use `rusoto_application_autoscaling` in your application, add it as a dependency in your `Cargo.toml`:
