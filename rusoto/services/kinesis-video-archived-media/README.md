...
# Rusoto KinesisVideoArchivedMedia
Rust SDK for Amazon Kinesis Video Streams Archived Media
...
To use `rusoto_kinesis_video_archived_media` in your application, add it as a dependency in your `Cargo.toml`:
