...
# Rusoto ServerlessRepo
Rust SDK for AWSServerlessApplicationRepository
...
To use `rusoto_serverlessrepo` in your application, add it as a dependency in your `Cargo.toml`:
