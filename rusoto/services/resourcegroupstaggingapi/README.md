...
# Rusoto ResourceGroupsTaggingApi
Rust SDK for AWS Resource Groups Tagging API
...
To use `rusoto_resourcegroupstaggingapi` in your application, add it as a dependency in your `Cargo.toml`:
