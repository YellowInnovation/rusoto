...
# Rusoto KinesisVideoMedia
Rust SDK for Amazon Kinesis Video Streams Media
...
To use `rusoto_kinesis_video_media` in your application, add it as a dependency in your `Cargo.toml`:
