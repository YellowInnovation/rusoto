...
# Rusoto ComprehendMedical
Rust SDK for AWS Comprehend Medical
...
To use `rusoto_comprehendmedical` in your application, add it as a dependency in your `Cargo.toml`:
