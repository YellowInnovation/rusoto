...
# Rusoto Iot1ClickDevices
Rust SDK for AWS IoT 1-Click Devices Service
...
To use `rusoto_iot1click_devices` in your application, add it as a dependency in your `Cargo.toml`:
