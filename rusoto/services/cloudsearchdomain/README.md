...
# Rusoto CloudSearchDomain
Rust SDK for Amazon CloudSearch Domain
...
To use `rusoto_cloudsearchdomain` in your application, add it as a dependency in your `Cargo.toml`:
