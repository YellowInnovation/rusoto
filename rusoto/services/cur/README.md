...
# Rusoto CostAndUsageReport
Rust SDK for AWS Cost and Usage Report Service
...
To use `rusoto_cur` in your application, add it as a dependency in your `Cargo.toml`:
