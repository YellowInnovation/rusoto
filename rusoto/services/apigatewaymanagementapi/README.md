...
# Rusoto ApiGatewayManagementApi
Rust SDK for AmazonApiGatewayManagementApi
...
To use `rusoto_apigatewaymanagementapi` in your application, add it as a dependency in your `Cargo.toml`:
