...
# Rusoto MarketplaceCommerceAnalytics
Rust SDK for AWS Marketplace Commerce Analytics
...
To use `rusoto_marketplacecommerceanalytics` in your application, add it as a dependency in your `Cargo.toml`:
